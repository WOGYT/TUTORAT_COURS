...
\newcommand{\tcolorexo}[2][]{
\begin{tcolorbox}[breakable,pad at break*=3mm, colback=ForestGreen!5!white, colframe=ForestGreen!75!black, title={\textbf{#1}},halign title=left]
#2
\end{tcolorbox}
}

\newcommand{\tcolorgris}[2][]{
\begin{tcolorbox}[breakable,pad at break*=2mm, colback=gray!12!white, boxrule=0pt,frame hidden, colframe=gray!12!white]{\textbf{#1}}
\, #2
\end{tcolorbox}}

\newcommand{\tcolormagenta}[2][]{
\begin{tcolorbox}[breakable, pad at break*=2mm, colback=Magenta!12!white, boxrule=0pt,frame hidden, colframe=gray!12!white]{\textbf{#1}} 
#2
\end{tcolorbox}}

\newcommand{\tcolorvert}[2][]{
\begin{tcolorbox}[breakable, pad at break*=2mm, colback=ForestGreen!12!white, boxrule=0pt,frame hidden, colframe=gray!12!white]{\textbf{#1}} 
#2
\end{tcolorbox}}
...
L'erreur serait de penser que les matrices ne sont que des tableaux de nombre. En effet, on peut les voir comme tel mais c'est loin d'être suffisant quand on les manipule en maths. En effet, les tableaux, c'est juste une représentation de nombre, en lui-même, sans structure, il sert à rien. On va donc munir l'espace des matrices de plusieurs opérations. 
