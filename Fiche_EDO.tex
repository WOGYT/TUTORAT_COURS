...
\subsection{Présentation et origine du problème}
...
(E_0): \text{   } y' + a(t)y = 0
$$
Avec $a(t) \in E $ une fonction quelconque qui dépend de t (évidement, ça peut être une fonction constant auquel cas $a(t)$ est un scalaire.
\end{tcolorbox}
...
De plus si $r_1 = r_2$ ($\Delta = 0$), on a: 
