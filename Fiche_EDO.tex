...
\end{itemize}
C'est toujours un modèle non linéaire. Ce modèle, contrairement à Lotka-Volterra, ne met pas en évidence une périodicité de la quantité de proies et de prédateur, mais qu'il prédit plutôt un équilibre entre les deux populations au bout d'un certain temps. 
\end{tcolorbox}
